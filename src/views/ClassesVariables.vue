<template>
  <q-page class="q-pa-xl">
    ...
    <section class="q-mb-xl">
      ...
      <q-separator class="q-my-md" />
      <div class="ellipsis">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore hic consequuntur atque, odio iusto repellat id excepturi nihil, beatae minima sapiente ab explicabo, sequi
        enim ut nisi veritatis. Aliquid, dolor!
      </div>
      <hr />

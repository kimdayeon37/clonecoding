    ...
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs">
        <div class="bg-dark text-white">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui quasi cum sed a voluptate atque, corrupti eaque in fugit, saepe nesciunt! Veniam consectetur excepturi natus
          corporis, totam accusamus temporibus beatae.
        </div>
      </div>
      ...
      <div class="bg-primary q-mt-md flex flex-center" style="width: 100%; height: 400px">
        <div class="bg-dark text-white" style="width: 100px; height: 100px">Hello</div>
      </div>
    </section>
    <section class="q-mb-xl">
